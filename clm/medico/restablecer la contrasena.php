...
$query=mysqli_query($con,"update doctor set password='$newpassword' where contactno='$cno' and docEmail='$email'");
if ($query) {
echo "<script>alert('Contrasena actualizada correctamente.');</script>";
...
<html lang="en">
	<head>
		<title>Restablecimiento de contrasena</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> CLM | Restablecimiento de contrasena del paciente</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" name="passwordreset" method="post" onSubmit="return valid();">
						<fieldset>
							<legend>
							Restablecimiento de contrasena del paciente
							</legend>
							<p>
							Establezca su nueva contrasena.<br />
