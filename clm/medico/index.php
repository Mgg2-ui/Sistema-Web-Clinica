...
$_SESSION['errmsg']="usuario o contrasena invalido";
$extra="index.php";
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
exit();
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.php">	<h2> CLM | MEDICO Login</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> CLM</span>. <span>Derechos reservados del autor Cristian</span>
					</div>
