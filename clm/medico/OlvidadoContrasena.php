...
echo "<script>window.location.href =' OlvidadoContrasena.php'</script>";
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> CLM | Recuperacion de la contrasena del medico</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
							Recuperacion de la contrasena del medico
							</legend>
							<p>
							Ingrese su numero de contacto y correo electronico para recuperar su contrasena.<br />
