...
<tbody>
<?php
$sql=mysqli_query($con,"select * from tblpaciente where PatientName like '%$sdata%'|| PatientContno like '%$sdata%'");
...
<a href="editar-paciente.php?editid=<?php echo $row['ID'];?>"><i class="fa fa-edit"></i></a> || <a href="ver-paciente.php?viewid=<?php echo $row['ID'];?>"><i class="fa fa-eye"></i></a>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> No se encontro ningun registro en esta busqueda</td>
