...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
      ...
      $query.=mysqli_query($con, "insert   tblhistorialmedico(PatientID,BloodPressure,BloodSugar,Weight,Temperature,MedicalPres)value('$vid','$bp','$bs','$weight','$temp','$pres')");
    if ($query) {
    echo '<script>alert("Se ha agregado la historia de la medico.")</script>';
...
<html lang="en">
	<head>
		<title>Medico | Gestionar pacientes</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Medico | Gestionar pacientes</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Medico</span>
...
<?php
                               $vid=$_GET['viewid'];
                               $ret=mysqli_query($con,"select * from tblpaciente where ID='$vid'");
$cnt=1;
...
Detalles del paciente</td></tr>
    ...
    <th scope>Correo electronico del paciente</th>
    <td><?php  echo $row['PatientEmail'];?></td>
  </tr>
  <tr>
    <th scope>Numero de movil del paciente</th>
  ...
  <tr>
    ...
    <th>Historial medico del paciente(if any)</th>
...
$ret=mysqli_query($con,"select * from tblhistorialmedico  where PatientID='$vid'");
