...
if(isset($_GET['cancel']))
		  {
mysqli_query($con,"update cita set doctorStatus='0' where id ='".$_GET['id']."'");
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select users.fullName as fname,cita.*  from cita join users on users.id=cita.userId where cita.doctorId='".$_SESSION['id']."'");
$cnt=1;
