...
if($sql)
{
$msg="Detalles del Medico actualizados con exito";
...
<html lang="en">
	<head>
		<title>Admin | Editar detalles del Medico</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Editar detalles del Medico</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar la informacion del medico</h5>
												</div>
