				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								...
								<ol class="breadcrumb">
									...
									<li class="active">
										<span>consultas de lecturas</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gestionar <span class="text-bold">Leerconsultas</span></h5>
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from tblcontactos where IsRead is not null");
$cnt=1;
...
?>
							...
							<a href="Detalles-deconsulta.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-lg" title="View Details"><i class="fa fa-file"></i></a>
												</div>
