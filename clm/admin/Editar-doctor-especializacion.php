...
$sql=mysqli_query($con,"update  especializacion set specilization='$docspecialization' where id='$id'");
$_SESSION['msg']="Medico Especializacion actualizada con exito !!";
} 
...
<html lang="en">
	<head>
		<title>Admin | Editar Medico Especializacion</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin |Editar Doctor Especializacion</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Editar Doctor Especializacion</h5>
												</div>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
													<form role="form" name="dcotorspcl" method="post" >
														<div class="form-group">
															...
															Editar Doctor Especializacion
															</label>

	<?php 

$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from Editar-doctor-especializacion where id='$id'");
