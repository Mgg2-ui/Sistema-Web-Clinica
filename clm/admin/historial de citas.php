									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Dia de la cita / Time </th>
												<th>Fecha de creacion de la cita  </th>
												<th>Estatuto actual</th>
												<th>Accion</th>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select doctor.doctorName as docname,users.fullName as pname,cita.*  from appointment join doctor on doctor.id=cita.doctorId join users on users.id=cita.userId ");
$cnt=1;
