...
{
$sql=mysqli_query($con,"insert into especializacion(specilization) values('".$_POST['doctorspecilization']."')");
$_SESSION['msg']="Medico Especialización actualizada con éxito !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from especializacion where id = '".$_GET['id']."'");
...
<html lang="en">
	<head>
		<title>Admin |Medico Especializacion</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Agregar especializacion de medico</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Agregar especializacion de medico</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Medico Especializacion</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Gestionar <span class="text-bold">Especializacion en doctores</span></h5>
...
?>
							...
							<a href="editar-doctor-especializacion.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
													
	<a href="medico-especializacion.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><i class="fa fa-times fa fa-white"></i></a>
												</div>
