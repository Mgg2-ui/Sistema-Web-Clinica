...
<html lang="en">
	<head>
		<title>Usuarios registrados | Ver historial medico</title>
...
<?php
$uid=$_SESSION['id'];
$sql=mysqli_query($con,"select tblpaciente.* from tblpaciente join users on users.email=tblpaciente.PatientEmail where users.id='$uid'");
$cnt=1;
...
<a href="ver-mi historial.php?viewid=<?php echo $row['ID'];?>"><i class="fa fa-eye"></i></a>
