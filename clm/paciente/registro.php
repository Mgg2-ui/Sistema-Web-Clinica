...
if($query)
{
	echo "<script>alert('Registrado exitosamente. Puede iniciar sesion ahora');</script>";
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2>CLM | Registro de pacientes</h2></a>
				</div>
				<!-- start: REGISTER BOX -->
				<div class="box-register">
					<form name="registration" id="registration"  method="post" onSubmit="return valid();">
						<fieldset>
							...
							<p>
							Ingrese los detalles de su cuenta a continuacion:
							</p>
							<div class="form-group">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> CLM</span>. <span>Derechos Reservados</span>
					</div>
