...
if(isset($_GET['cancel']))
		  {
		          mysqli_query($con,"update cita set userStatus='0' where id = '".$_GET['id']."'");
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select doctor.doctorName as docname,cita.*  from cita join doctor on doctor.id=cita.doctorId where cita.userId='".$_SESSION['id']."'");
$cnt=1;
...
{ ?>
	...
	<a href="historial de citas.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this appointment ?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Appointment" tooltip-placement="top" tooltip="Remove">Cancel</a>
	<?php } else {
